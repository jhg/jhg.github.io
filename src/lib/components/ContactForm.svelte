...
>
	<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
		...
		<div>
			...
			<input id="email" name="email" type="email" required autocomplete="email"
				...
				class="w-full h-[42px] px-2 py-1 rounded border border-gray-400 transition duration-300 bg-transparent text-white placeholder-gray-400 focus:outline-none focus:border-gray-500 invalid:border-red-300"
			/>
		</div>
	</div>
	...
	<div class="mb-4">
		...
		<textarea id="message" name="message" required placeholder="Tell me about your project or question..."
			...
			class="w-full min-h-[150px] max-h-[300px] px-2 py-1 rounded border border-gray-400 transition duration-300 bg-transparent text-white placeholder-gray-400 focus:outline-none focus:border-gray-500 invalid:border-red-300 resize-y"
		></textarea>
	</div>
